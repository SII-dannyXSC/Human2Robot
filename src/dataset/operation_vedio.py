...
class OperationVideoDataset(Dataset):
    ...
    #         human_img = human_reader[index]
    #         human_image_list.append(Image.fromarray(human_img.asnumpy()))
    #         robot_img = robot_reader[index]
    #         robot_image_list.append(Image.fromarray(robot_img.asnumpy()))

    #     # set ref img as start frame of robot video
    #     ref_img_idx = start_idx
    #     ref_img = Image.fromarray(robot_reader[ref_img_idx].asnumpy())

    #     # TODO: dannyXSC do same crop
