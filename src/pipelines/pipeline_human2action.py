...
@dataclass
class Human2ActionPipelineOutput(BaseOutput):
    videos: Union[torch.Tensor, np.ndarray]


class Human2ActionPipeline(DiffusionPipeline):
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred = result[0]
                intermidate_feature_list = result[1]
                # if i in record_step:
        ...
        return Human2ActionPipelineOutput(videos=images)
