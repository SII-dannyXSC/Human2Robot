...
@dataclass
class Human2RobotImagePipelineOutput(BaseOutput):
    images: Union[torch.Tensor, np.ndarray]
    record_features: List


class Human2RobotImagePipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        ref_pose_cond_tensor = ref_pose_cond_tensor.unsqueeze(2)
        ...
        if stop_step is not None:
            return Human2RobotImagePipelineOutput(
                images=None, record_features=[record_features]
            )
        ...
        return Human2RobotImagePipelineOutput(
            images=image, record_features=record_features
        )
