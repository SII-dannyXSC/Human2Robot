...
class UNet3DConditionOutput(BaseOutput):
    ...
    intermediate_feature_list: List[torch.FloatTensor]
...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        intermediate_feature_list = [sample]
        # up
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            intermediate_feature_list.append(sample)
        ...
        return UNet3DConditionOutput(
            sample=sample, intermediate_feature_list=intermediate_feature_list
        )
